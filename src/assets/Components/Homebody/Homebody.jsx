    ...
    return(
        ...
        <div className={style.biomain}>
            <div className={style.biocard}>
                <motion.div className={style.biotext} initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1}}>
                    <h1>BIORYX</h1>
            ...
            <div className={style.biocard2}>
                ...
                <motion.div className={style.biotext2} initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1}}>
